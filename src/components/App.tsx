    ...
    <div className="App">
      ...
      <section className="section background">
        ...
        <div className="section_content">
          <p>I graduated a rigorous six-month long bootcamp, learning all from the very basics to advanced site structures, requiring not only determination but also the ability to critically think and problem solve.</p>
